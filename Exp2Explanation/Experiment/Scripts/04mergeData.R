...
load(here('Exp2Explanation', 'Experiment', 'Data', 'processedData.rda'))

# Get the ratings: this is the intersection of two raters, taken in processRatings.R and mergeRating.R
load(here('Exp2Explanation', 'Experiment', 'Data', 'ratingIntersect.rda'))
...
rated_explans <- cbind(df, ratings)[, -11]
...
save(
  rated_explans,
  file = here('Exp2Explanation', 'Experiment', 'Data', 'ratedExplans.rda')
)
