...
load(here('Exp1Prediction', 'Model', 'Data', 'model.rda')) # from exp1 03processModel.r: six dfs of best path, food and their params, plus active_path and active_food


# ------- Step 1: Get params ---------------

gofood <- best_food_params[2:11]
