...
pB <- c(0.1,0.9) #  
peB <- c(0.7,0.3) # Note for toy version we can't have extreme values because sometimes all resample is false and then sd is zero
...
save(params, dfd, dfc, mp1c, mp1d, file='collidertest.Rdata') # ie collider 1 is with pA and pB base rate .5,.5
